  ...
  <article class="group flex h-full flex-col rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 p-4 shadow-md ring-1 ring-zinc-200/70 dark:ring-zinc-800/70 transition hover:shadow-lg md:p-6">
    ...
    <div class="mt-auto flex flex-wrap items-center gap-3">
      <CopyButton
        ...
        :button-class="buttonClass || 'relative overflow-hidden bg-gradient-to-r from-brand-500 via-sky-500 to-brand-600 text-white shadow-lg shadow-brand-500/20 hover:shadow-xl focus-visible:ring-white/80 focus-visible:ring-offset-2 focus-visible:ring-offset-brand-500 before:absolute before:inset-[-3px] before:rounded-full before:bg-[conic-gradient(from_90deg,rgba(255,255,255,0.8),rgba(56,189,248,0.45),rgba(255,255,255,0.8))] [before:mask:radial-gradient(circle,transparent_0,transparent_60%,#000_64%,#000_100%)] before:opacity-80 before:animate-[spin_10s_linear_infinite] before:pointer-events-none after:absolute after:inset-[1px] after:rounded-full after:border after:border-white/25 [after:mask:radial-gradient(circle,transparent_0,transparent_70%,#000_74%,#000_100%)] after:opacity-70 after:animate-[spin_12s_linear_infinite_reverse] after:pointer-events-none'"
        :copied="copied"
