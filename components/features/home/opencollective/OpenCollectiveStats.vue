  ...
  >
    <div class="mx-auto max-w-6xl px-4 py-12 md:py-16">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div class="rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white/90 dark:bg-zinc-900/90 p-6 shadow-sm ring-1 ring-zinc-200/70 dark:ring-zinc-800/70">
          <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ t('collective.raised') }}</p>
          <p class="mt-1 text-3xl font-bold text-neutral-900 dark:text-neutral-100">{{ formattedRaised }}</p>
        ...
        <div class="rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white/90 dark:bg-zinc-900/90 p-6 shadow-sm ring-1 ring-zinc-200/70 dark:ring-zinc-800/70 flex flex-col justify-between">
          <div>
        ...
        <a
          ...
          class="rounded-2xl border border-brand-100/70 dark:border-brand-900/60 bg-brand-50/90 dark:bg-brand-900/30 p-6 shadow-sm ring-1 ring-brand-100/80 dark:ring-brand-900/60 transition hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
