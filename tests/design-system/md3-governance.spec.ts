...
const PENDING_MIGRATION: Record<string, Rule[]> = {
  ...
  'layers/community-poi/components/CommunityPoiCard.vue': [
    'palette',
    'dark-colour',
    'shape',
    'elevation',
  ...
  'layers/community-poi/components/CommunityPoiCoordsCopy.vue': [
    'palette',
    'shape',
    'button',
  ],
  'layers/community-poi/components/CommunityPoiGallery.vue': [
    'palette',
    'dark-colour',
    'shape',
    'button',
  ],
  'layers/community-poi/components/CommunityPoiGoalState.vue': [
    'palette',
    'dark-colour',
    'shape',
  ],
  'layers/community-poi/components/CommunityPoiGrid.vue': [
    'palette',
    'dark-colour',
    'shape',
  ],
  'layers/community-poi/components/CommunityPoiLitematicaHelp.vue': [
    'palette',
    'dark-colour',
    'shape',
  ],
  'layers/community-poi/components/CommunityPoiLore.vue': [
    'palette',
    'dark-colour',
    'shape',
  ],
