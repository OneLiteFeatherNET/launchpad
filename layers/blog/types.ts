...
// layer permitted to name the content module directly
// (module-boundaries.spec.ts). This re-exports them under the same names and
// adds the one plain shape that is specific to this layer.
