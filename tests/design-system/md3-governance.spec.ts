...
'elevation',
'button'],
  'layers/blog/components/ArticleCard.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/blog/components/FeaturedTeamMembers.vue': ['palette',
'dark-colour',
'shape',
'button'],
  'layers/blog/components/SocialMediaShare.vue': ['palette',
'dark-colour',
'button'],
  'layers/blog/components/Top1.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/community-poi/components/CommunityPoiBluemap.vue': ['palette',
'dark-colour',
'shape',
'elevation',
'button'],
  'layers/community-poi/components/CommunityPoiCard.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/community-poi/components/CommunityPoiCategoryBadge.vue': ['palette', 'dark-colour'],
  'layers/community-poi/components/CommunityPoiCollaboration.vue': ['palette', 'shape'],
  'layers/community-poi/components/CommunityPoiContributeInfo.vue': ['palette', 'shape'],
  'layers/community-poi/components/CommunityPoiCoordsCopy.vue': ['palette',
'shape',
'button'],
  'layers/community-poi/components/CommunityPoiGallery.vue': ['palette',
'dark-colour',
'shape',
'button'],
  'layers/community-poi/components/CommunityPoiGoalState.vue': ['palette',
'dark-colour',
'shape'],
  'layers/community-poi/components/CommunityPoiGrid.vue': ['palette',
'dark-colour',
'shape'],
  'layers/community-poi/components/CommunityPoiLitematicaHelp.vue': ['palette',
'dark-colour',
'shape'],
  'layers/community-poi/components/CommunityPoiLore.vue': ['palette',
'dark-colour',
'shape'],
  ...
  'layers/community-poi/components/CommunityPoiSchematicList.vue': ['palette',
'dark-colour',
'shape',
'elevation',
'button'],
  'layers/community-poi/components/CommunityPoiStatusBadge.vue': ['palette', 'dark-colour'],
  'layers/content-core/components/ProseA.vue': ['palette',
'dark-colour',
'shape'],
  'layers/content-core/components/ProseHeading.vue': ['palette',
'dark-colour',
'shape'],
  ...
  'layers/content-core/components/ProsePre.vue': ['palette',
'dark-colour',
'shape'],
  'layers/footer/components/SiteFooter.vue': ['palette', 'dark-colour'],
  'layers/home/components/Carousel.vue': ['palette',
'shape',
'elevation',
'button'],
  'layers/home/components/CarouselItemBlog.vue': ['palette',
'shape',
'button'],
  'layers/home/components/CarouselItemEvent.vue': ['palette',
'shape',
'button'],
  'layers/home/components/CarouselItemImage.vue': ['palette', 'shape'],
  'layers/home/components/CarouselItemNews.vue': ['palette',
'shape',
'button'],
  'layers/home/components/CarouselItemPoi.vue': ['palette',
'shape',
'button'],
  'layers/home/components/FaqSection.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/home/components/ServerAddressCard.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/home/components/ServerAddresses.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/home/components/ServerConcept.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/navigation/components/LanguageSelector.vue': ['palette',
'dark-colour',
'shape',
'elevation',
'button'],
  'layers/navigation/components/NavigationBar.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/navigation/components/NavigationItem.vue': ['palette',
'dark-colour',
'shape',
'button'],
  'layers/opencollective/components/OpenCollectiveStats.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/sponsoring/components/Sponsoring.vue': ['palette',
'dark-colour',
'shape',
'elevation',
'button'],
  'layers/team/components/OpenPositionCard.vue': ['palette',
'dark-colour',
'shape',
'button'],
  'layers/team/components/TeamFaqSection.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layers/team/components/TeamMemberCard.vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'layouts/default.vue': ['palette', 'dark-colour'],
  'pages/blog/[...slug].vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'pages/bluemap.vue': ['palette', 'shape'],
  'pages/community-poi/[...slug].vue': ['palette',
'dark-colour',
'shape',
'elevation'],
  'pages/community-poi/index.vue': ['palette', 'dark-colour'],
  'pages/imprint.vue': ['palette',
'dark-colour',
'shape'],
  'pages/privacy.vue': ['palette', 'dark-colour'],
  'pages/team/[slug].vue': ['palette',
'dark-colour',
'shape',
'button'],
